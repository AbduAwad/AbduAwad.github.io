     ...
     <div className='logo-container'>
      ...
      <div className="navbar">
        <ul ref={menuRef} className='nav-menu'>
          <li><AnchorLink className='anchor-link' offset = {50} href="#home"><p className='home' onClick={()=>setMenu("home")}>Home</p></AnchorLink>{menu==="home"} </li>
          ...
          <li><AnchorLink className='anchor-link' offset = {50} href="#work"><p onClick={()=>setMenu("work")}>Experience</p></AnchorLink>{menu==="work"}</li>
        ...
        <div className="nav-connect"><AnchorLink className='anchor-link'></AnchorLink></div>
      </div>
    </nav>
  );
};
